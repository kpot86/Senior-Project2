...
//            }
    ...
    public function details($project_id)
    {
       ...
       // $isProjectClosed = $this->isProjectClosedInternal($project_id);
        if(((int)$proposedBy->proposed_by == getCurrentUserId($this))) 
                //&& !$isProjectClosed)   
...
//                else
               ...
               // }
                ...
                if (isset($new_project) && $new_project)
                {
                    ...
                    else $updated_project->status = "APPROVED";                    
...
//    }
    ...
    private function deleteInternal($project_id)
    {
        ...
        //check for status pending for approval and deadline
//        if(true)
//        {
...
//            }
            ...
            {
               // echo var_dump(count($project_team));
              //  die;
            //for($i = 0; $i < count($project_team); $i++)
            //{
            ...
            //}
                ...
                setFlashMessage($this, 'The project is full');
